...
const uploadImagenRepresentativa = multer({ storage: storageImagenRepresentativa }).array('movilImage');
const uploadImagenProcesada = multer({ storage: storageImagenProcesada }).array('movilImage');
