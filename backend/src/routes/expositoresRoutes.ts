...
import { getExpositores, deleteExpositor,guardarExpositor,editarEstadoElemento,getRegionesDisponibles } from '../controller/expositorController';
...
router.post('/expositorActivaDesactiva', editarEstadoElemento);
