...
import { expositorService, mobiliarioService } from '../services/mobiliarioService';
...
export async function updateExpositor(req: Request, res: Response) {
  try {
    ...
    const expositorActualizado= await expositorService.updateExpositor(id, nombre, atributos_expositores);
