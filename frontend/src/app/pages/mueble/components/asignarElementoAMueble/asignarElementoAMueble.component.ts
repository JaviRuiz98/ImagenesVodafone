...
@Component({
  selector: 'app-asignarElementoAMueble',
  templateUrl: './asignarElementoAMueble.component.html',
  styleUrls: ['./asignarElementoAMueble.component.css']
})
export class AsignarElementoAMuebleComponent implements OnInit {


  constructor(private elementosService: ElementosService) { }

  @Input () imagen?: expositores;
